...
namespace Epr.Reprocessor.Exporter.Facade.Api.Controllers.ExporterJourney
{
	...
	public class WasteCarrierBrokerDealerRefController : Controller
	{
        ...
        {
            _logger.LogInformation("Get WasteCarrierBrokerDealerRef for registrationId: {RegistrationId}", registrationId);
    ...
    public async virtual Task<IActionResult> Post([FromBody] WasteCarrierBrokerDealerRefDto value)
        {
            _logger.LogInformation("Create WasteCarrierBrokerDealerRef for registrationId: {RegistrationId}", value.RegistrationId);
        ...
        {
            _logger.LogInformation("Update WasteCarrierBrokerDealerRef for registrationId: {RegistrationId}", value.RegistrationId);
